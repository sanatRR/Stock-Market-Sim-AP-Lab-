...
def register():
    ...
    username_lable = Label(register_screen, text="Username * ",height="2", width="32",font=("Comic Sans MS", 16))
    username_lable.pack()
...
def login():
    ...
    Label(login_screen, text="Username * ",height="2", width="32",font=("Comic Sans MS", 16)).pack()
